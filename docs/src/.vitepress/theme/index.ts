...
export const Theme: ThemeConfig = {
  ...
  enhanceApp({ app, router, siteData }) {
    ...
    // re-process + .htmxo-embed link rewriting. ReparametrizableDistributions
    // uses `/live-rd` (matches the Vite proxy in config.mts and committed
    // recordings under public/live-rd/).
    setupHtmxoEmbed(router, { proxyPrefix: '/live-rd' });
  }
}
